...
namespace MBSharpTest
{
    ...
    {     
        ...
        void hunyin2()
        {
            ...
            MBBuilder MBBuilder = new MBBuilder("./test.mp4", 1280, 720, pts);
            MBVideoTrack videoTrack = new MBVideoTrack();
            //设置一段视频开始时间和结束时间，开始时间0s，结束时间5s
            ...
            MBAudioLayer auidoLayer1 = new MBAudioLayer(0.0, 30.0);
            MBAudioLayer auidoLayer2 = new MBAudioLayer(0.0, 30.0);
