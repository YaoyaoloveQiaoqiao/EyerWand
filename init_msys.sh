...
./configure --enable-static --enable-shared --prefix=./ffmpeg_install --enable-libx264 --enable-gpl --enable-pic --extra-cflags=-I${basepath}/MB3rdpart/x264/x264_install/include/ --extra-ldflags=-L${basepath}/MB3rdpart/x264/x264_install/lib/
